...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Culmulative GPA: 3.9/4.25
            \item \textbf{Relevant Coursework:} Full Stack App Development, Object Oriented Programming, Data Structures, Software Engineering and Professional Practices, Functional Programming, Artificial Intelligence
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Culmulative Average: 83.33\%
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Analyzed large datasets using Python, Pandas, and statistical analysis techniques to extract actionable business insights
            \item Developed interactive data visualizations and dashboards using Tableau to present findings to stakeholders
            \item Implemented machine learning models using Scikit-learn and PyTorch for predictive analytics and pattern recognition
            \item Collaborated with cross-functional teams to identify data requirements and deliver comprehensive analytical reports
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Professional Development:} Preparing for AWS Cloud Practitioner certification; self-directed learning on deep neural networks through Udemy
    \end{onecolentry}
