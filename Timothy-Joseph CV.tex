...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item \textbf{Relevant Coursework:} Data Structures \& Algorithms, Object Oriented Programming, Software Engineering and Professional Practices, Functional Programming, Artificial Intelligence, Operating Systems \& Systems Programming
        \end{highlights}
    \end{onecolentry}
