...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            ...
            \item Achieved 30/30 feasibility across all benchmark instances with Improved BGA, incorporating pseudo-random initialisation, stochastic ranking and heuristic improvement operators
            \item Optimised runtime through vectorised NumPy operations and parallel experimental runs across 30 seeds per algorithm
        \end{highlights}
    \end{onecolentry}
