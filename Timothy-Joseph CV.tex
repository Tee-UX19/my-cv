...
\begin{document}
    ...
    \begin{header}
        ...
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://linkedin.com/in/timothy-joseph-godwin}{linkedin.com/in/timothy-joseph-godwin}}%
        \kern 5.0 pt%
        \AND%
        \kern 5.0 pt%
        \mbox{\hrefWithoutArrow{https://github.com/Tee-UX19}{github.com/Tee-UX19}}%
    \end{header}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Expected First Class Honours, Year 1 Average: 72\%
