...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Cleaned and analyzed multi-source customer data using Pandas, uncovering acquisition trends, regional gaps, and plan preferences to inform marketing strategy for SaaS and e-commerce clients
