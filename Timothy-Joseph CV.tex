...
\usepackage[
    ...
    left=0.8cm, % seperation between body and page edge from the left
    right=0.8cm, % seperation between body and page edge from the right
...
% Some settings:
\raggedright
\linespread{0.98} % slightly reduce line spacing
...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item \textbf{Cumulative GPA:} 3.9/4.25
