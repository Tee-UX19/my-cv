...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Implemented Simulated Annealing and Binary Genetic Algorithm (Standard and Improved) metaheuristics for the NP-hard Set Partitioning Problem
            \item Achieved 30/30 feasibility across all benchmarks with Improved BGA via pseudo-random initialisation, stochastic ranking and heuristic improvement
            \item Resolved IBGA runtime bottleneck via precomputed lookups and vectorised NumPy operations over 30 runs
        \end{highlights}
    \end{onecolentry}
