...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Led CI/CD pipeline implementation for 7-member team using Azure for deployment, Docker containerization, and GitHub Actions runners
            \item Enhanced user experience by developing responsive design for smaller screens and other accessibility features.
            \item Architected RESTful APIs with Spring Boot and resolved database migration issues with Liquibase
        \end{highlights}
    \end{onecolentry}
