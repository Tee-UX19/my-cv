...
\begin{document}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item \textbf{Relevant Coursework:} Data Structures \& Algorithms, Object Oriented Programming, Software Engineering and Professional Practices, Team Project, Artificial Intelligence, Operating Systems \& Systems Programming
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{twocolentry}{
        ...
        \textbf{Airline Crew Scheduling Optimisation}
    \end{twocolentry}

    \vspace{0.10 cm}
    \begin{onecolentry}
        \begin{highlights}
            \item Implemented and compared three metaheuristic algorithms (Simulated Annealing, Standard and Improved Binary Genetic Algorithm) for the NP-hard Set Partitioning Problem
            \item Achieved 30/30 feasibility across all benchmark instances with Improved BGA, incorporating pseudo-random initialisation, stochastic ranking and heuristic improvement operators from research papers
            \item Identified and resolved IBGA runtime bottleneck by replacing repeated matrix scans with precomputed column/row lookups and vectorised NumPy operations, evaluated over 30 independent runs per algorithm
        \end{highlights}
    \end{onecolentry}
    ...
    \begin{onecolentry}
        \textbf{Cloud \& Databases:} GCP (Storage, Dataproc, Composer, BigQuery), AWS, Docker, GitHub, Azure,  Apache Airflow
    \end{onecolentry}
