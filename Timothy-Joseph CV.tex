...
\begin{document}
    ...
    \begin{twocolentry}{
        ...
        M.Eng Computer Science with Software Engineering | \textbf{GPA: 3.9/4.25}
    \end{twocolentry}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Built enterprise-scale ETL pipeline processing 300,000+ records using Python, Apache Spark, and Google Cloud Platform, achieving 80\% storage optimization through Parquet format and implementing real-time API integration with comprehensive error handling
            \item Orchestrated production data workflows using Apache Airflow on Google Cloud Composer, implementing automated scheduling, email monitoring, BigQuery metadata tracking, and data validation checkpoints ensuring 99\%+ pipeline reliability
            \item Designed BigQuery data warehouse with partitioned/clustered tables processing \$15.3M transaction volume across 5 currencies, implementing query optimization techniques reducing costs by 80\% through partition pruning and clustering strategies
            \item Deployed distributed data processing using Apache Spark on GCP Dataproc cluster, scaling from single-machine processing to 3-node distributed architecture, processing 95,000+ clickstream events and 50,000+ financial transactions with zero data loss
        \end{highlights}
    \end{onecolentry}
