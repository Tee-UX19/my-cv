...
\begin{document}
    ...
    \begin{twocolentry}{
        \textit{JHipster, Angular, Spring Boot}
    }
        % \href{https://github.com/Tee-UX19}{github.com/Tee-UX19}
    ...
    \begin{onecolentry}
        \begin{highlights}
            \item Led CI/CD pipeline implementation for 7-member team using Azure deployment, Docker containerization, and GitHub Actions runners in VM environment
